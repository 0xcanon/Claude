 ...
 * there are real orders to be told about, and every failure path is silent:
 * saying no leaves a fully working app.
 *
 ...
 * sound, and never silently swallowed. A new wholesale order is the whole
 * point of this app knowing how to buzz.
 */
...
export async function getPushToken(): Promise<string | null> {
  ...
  try {
    ...
    // failure — none of these should interrupt the owner's morning.
    return null;
  }
}
