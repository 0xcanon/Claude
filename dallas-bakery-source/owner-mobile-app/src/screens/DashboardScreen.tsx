...
const styles = StyleSheet.create({
  ...
  accountEmail: { marginTop: 2, color: "#BAA99D", fontFamily: fonts.sans, fontSize: 8 },
  signOut: { minHeight: 40, justifyContent: "center", paddingHorizontal: 10, borderWidth: 1, borderColor: colors.lineDark },
  signOutText: { color: colors.paper, fontFamily: fonts.sansMedium, fontSize: 8, letterSpacing: 0.7 },
  ...
  shippingKicker: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 8, letterSpacing: 1.4 },
  ...
  shippingLabel: { marginBottom: 7, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 7, letterSpacing: 0.9 },
  ...
  searchLabel: { marginRight: 12, color: "#BEAFA4", fontFamily: fonts.sansMedium, fontSize: 8, letterSpacing: 1.2 },
