...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: "#BFAFA4", fontFamily: fonts.sansMedium, fontSize: 9.8, letterSpacing: 1.4 },
  ...
  outlineBadgeText: { color: colors.sage, fontFamily: fonts.sansMedium, fontSize: 9.8, letterSpacing: 0.8 },
  ...
  infoLabel: { marginBottom: 10, color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.8, letterSpacing: 1.2 },
  ...
  signalLabel: { color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 0.8 },
  ...
  notesLabel: { marginBottom: 10, color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.8, letterSpacing: 1.2 },
