...
const styles = StyleSheet.create({
  ...
  soldOutText: { color: colors.paper, fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.8, textAlign: "center" },
  tags: { height: 0, alignItems: "flex-start", paddingHorizontal: 8 },
  tag: { top: -11, paddingVertical: 4, paddingHorizontal: 7, borderRadius: 10, overflow: "hidden", color: colors.sage, backgroundColor: colors.sagePale, fontFamily: fonts.sansMedium, fontSize: 9, letterSpacing: 0.4 },
  content: { padding: 11, paddingTop: 16 },
  title: { color: colors.chocolate, fontFamily: fonts.serif, fontWeight: "700", fontSize: 15 },
  description: { marginTop: 3, color: colors.muted, fontFamily: fonts.sans, fontSize: 9.8 },
  ...
  unit: { color: colors.muted, fontFamily: fonts.sans, fontSize: 9.4 },
  ...
  caseNote: { marginTop: 7, color: colors.chocolate, fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.5 },
  allergens: { marginTop: 4, color: colors.chocolate, fontFamily: fonts.sansMedium, fontSize: 9, letterSpacing: 0.5 },
  shelf: { marginTop: 4, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9, letterSpacing: 0.65 },
});
