...
const styles = StyleSheet.create({
  ...
  rowDetail: { marginTop: 4, color: colors.muted, fontFamily: fonts.sans, fontSize: 8.5 },
  rowStatus: { marginTop: 4, color: colors.sage, fontFamily: fonts.sansMedium, fontSize: 6.5, letterSpacing: 0.6 },
  rowStatusLate: { marginTop: 4, color: colors.danger, fontFamily: fonts.sansMedium, fontSize: 6.5, letterSpacing: 0.6 },
  rowRight: { alignItems: "flex-end", gap: 5 },
  rowAmount: { color: colors.chocolate, fontFamily: fonts.sansMedium, fontSize: 11 },
  rowOpen: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 7, letterSpacing: 0.6 },
  more: { marginTop: 10, color: colors.muted, fontFamily: fonts.sans, fontSize: 8.5 },
