...
const styles = StyleSheet.create({
  ...
  stepLabel: { marginTop: 7, color: "#A2958C", fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.7 },
  ...
  trackCopy: { flex: 1 },
  trackLabel: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 1 },
