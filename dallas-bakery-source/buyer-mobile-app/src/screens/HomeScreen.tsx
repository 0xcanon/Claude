...
const styles = StyleSheet.create({
  ...
  approved: { paddingVertical: 6, paddingHorizontal: 9, borderRadius: 12, overflow: "hidden", color: colors.sage, backgroundColor: colors.sagePale, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 0.7 },
  locationName: { flex: 1, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 0.6, textAlign: "right" },
  ...
  sectionLabel: { marginTop: 25, marginBottom: 10, color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 1 },
  ...
  orderKicker: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 1 },
  orderTitle: { marginTop: 7, maxWidth: 220, color: colors.chocolate, fontFamily: fonts.serif, fontSize: 23, lineHeight: 27 },
  priceBlock: { alignItems: "flex-end" },
  priceFrom: { color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9, letterSpacing: 0.7 },
  price: { color: colors.rust, fontFamily: fonts.serif, fontWeight: "700", fontSize: 24 },
  priceUnit: { marginTop: 2, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9, letterSpacing: 0.7 },
  ...
  statLabel: { color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9, letterSpacing: 0.5 },
  locationCard: { marginTop: 14, padding: 15, backgroundColor: colors.chocolate },
  locationKicker: { color: colors.gold, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 1 },
