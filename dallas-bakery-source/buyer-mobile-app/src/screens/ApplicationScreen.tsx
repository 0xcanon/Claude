...
const styles = StyleSheet.create({
  ...
  step: { width: 62, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 7, letterSpacing: 0.8, textAlign: "right" },
  content: { padding: 18, paddingBottom: 42 },
  progress: { height: 3, marginBottom: 30, backgroundColor: colors.line },
  progressFill: { height: 3, backgroundColor: colors.rust },
  kicker: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 8, letterSpacing: 1.4 },
  ...
  label: { marginBottom: 7, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 7, letterSpacing: 0.9 },
