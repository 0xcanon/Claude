...
const styles = StyleSheet.create({
  ...
  deliverKicker: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 1 },
  ...
  deliverNote: { marginTop: 8, color: colors.muted, fontFamily: fonts.sans, fontSize: 10, lineHeight: 13 },
  ...
  accountFirstHint: { marginTop: 8, color: colors.muted, fontFamily: fonts.sans, fontSize: 10, textAlign: "center" },
  ...
  note: { marginTop: 12, color: colors.muted, fontFamily: fonts.sans, fontSize: 10, lineHeight: 13, textAlign: "center" },
});
