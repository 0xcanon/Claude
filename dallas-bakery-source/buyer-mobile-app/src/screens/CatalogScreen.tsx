...
const styles = StyleSheet.create({
  ...
  approved: { paddingVertical: 6, paddingHorizontal: 9, borderRadius: 11, overflow: "hidden", color: colors.sage, backgroundColor: colors.sagePale, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 0.7 },
  locationLabel: { color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.7 },
  ...
  searchLabel: { marginRight: 12, color: colors.paper, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 0.9 },
  ...
  capacityKicker: { color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.4, letterSpacing: 1 },
