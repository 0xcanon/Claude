...
const styles = StyleSheet.create({
  ...
  sectionLabel: { marginTop: 26, marginBottom: 9, color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 7, letterSpacing: 1 },
  ...
  lineLoaves: { marginTop: 3, color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 7.5, letterSpacing: 0.4 },
  ...
  shippingKicker: { color: colors.gold, fontFamily: fonts.sansMedium, fontSize: 7, letterSpacing: 0.9 },
  ...
  private: { marginTop: 12, color: colors.muted, fontFamily: fonts.sans, fontSize: 8.5, lineHeight: 13, textAlign: "center" },
});
