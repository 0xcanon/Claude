...
const styles = StyleSheet.create({
  ...
  pill: { paddingVertical: 4, paddingHorizontal: 8, borderRadius: 10, overflow: "hidden", fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.7 },
  ...
  termsOpen: { marginTop: 4, color: "#8A5716", fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.7 },
  termsSettled: { marginTop: 4, color: colors.sage, fontFamily: fonts.sansMedium, fontSize: 9.2, letterSpacing: 0.7 },
  metaRow: { marginTop: 11, flexDirection: "row", alignItems: "center", gap: 6 },
  meta: { color: colors.muted, fontFamily: fonts.sansMedium, fontSize: 10 },
  metaDot: { color: colors.line, fontFamily: fonts.sansMedium, fontSize: 10 },
  divider: { height: 1, marginTop: 14, marginBottom: 14, backgroundColor: colors.line },
  openHint: { marginTop: 14, color: colors.rust, fontFamily: fonts.sansMedium, fontSize: 9.6, letterSpacing: 0.9 },
